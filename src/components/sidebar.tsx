    ...
    >
      ...
      >
        <a
          ...
          onClick={onClose}
        >
          <span className="text-blue-500 transition-transform duration-700 hover:-rotate-45 dark:border-slate-700/80 dark:bg-slate-800/75 dark:text-slate-100 justify-center">
            <Icon name="sparky" className="h-6 w-6 fill-current stroke-none" />
          </span>
      ...
      <nav className={`grid gap-1 overflow-y-auto overflow-x-hidden px-1 pb-5 dark:border-slate-700/80 dark:bg-slate-800/75 dark:text-slate-100 ${collapsed ? "justify-center" : ""}`}>
        <a
          className={`flex w-full min-w-0 min-h-10 items-center gap-1 rounded-2xl transition hover:-translate-y-0.5 dark:border-slate-700/80 dark:bg-slate-800/75 dark:text-slate-100 px-4 py-3 text-dark-500 ${pathname === homeHref
        ...
        {tools.map((tool) => (
          <a
            className={`flex w-full min-w-0 min-h-10 items-center gap-1 rounded-2xl transition hover:-translate-y-0.5 dark:border-slate-700/80 dark:bg-slate-800/75 dark:text-slate-100 px-4 py-6 text-dark-400 ${pathname === tool.href
                ? "border border-blue-500/20 bg-gradient-to-r from-blue-600/20 to-indigo-600/10 font-semibold shadow-sm shadow-blue-900/20"
                : ""
              }`}
            href={tool.href}
