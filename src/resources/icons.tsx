...
const paths: Record<IconName, React.ReactNode> = {
  ...
  sparky: (
    <>
      ...
      <circle cx="8.7" cy="5.3" r="2.3" />
      <circle cx="15.3" cy="5.3" r="2.3" />
      <circle cx="19.8" cy="10" r="2.2" />
      <path d="M12 11.3C9.4 11.3 6.9 12.8 5.8 15.2 4.9 17.4 5.4 20.1 7.4 21.5 8.7 22.5 10.4 22.8 12 22.8 13.6 22.8 15.3 22.5 16.6 21.5 18.6 20.1 19.2 17.4 18.2 15.2 17.1 12.8 14.6 11.3 12 11.3Z" />
    </>
  ),
  palette: (
    <>
